    ...
    return (
        <div className='flex  justify-center'>
            <div className='flex flex-wrap max-w-[900px] space-x-3'>
                <img src="/entreprise.jpg" alt="" className='h-[560px]' />
                <div className='w-[400px]'>
                    ...
                    <h1 className='text-5xl text-blue-900 leading-tight'>
                        Entreprise de formation des jeunes dans les metiers digitaux
                    </h1>
